...
// It has a helper method that calculates the height for each node. 
// Using that helper method it compares the height left and right subtree of each node in the whole tree
